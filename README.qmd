...
Julia implementation of the contextual lasso from the NeurIPS 2023 paper ["The contextual lasso: Sparse linear models via deep neural networks"](https://papers.nips.cc/paper_files/paper/2023/hash/3f226824426a4d6ae3d3efad8883fc53-Abstract-Conference.html).
...
The `classo()` function fits a contextually sparse linear model using explanatory features `x`, contextual features `z`, and response `y`.
